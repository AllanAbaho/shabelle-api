    ...
    <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label class="col-md-3 col-form-label" for="citrus_seller_account">{{ translate('Citrus Seller Account') }}</label>
                    <div class="col-md-9">
                        <input type="text" name="citrus_seller_account" value="{{ $user->shop->citrus_seller_account }}" id="citrus_seller_account" class="form-control mb-3" placeholder="{{ translate('Citrus Seller Account')}}" readonly>
                        @error('citrus_seller_account')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label" for="citrus_personal_account">{{ translate('Citrus Personal Account') }}</label>
                    <div class="col-md-9">
                        <input type="text" name="citrus_personal_account" value="{{ $user->shop->citrus_personal_account }}" id="citrus_personal_account" class="form-control mb-3" placeholder="{{ translate('Citrus Personal Account')}}" readonly>
                        @error('citrus_personal_account')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                </div>

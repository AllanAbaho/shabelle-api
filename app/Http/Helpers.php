...
if (!function_exists('uploaded_asset')) {
    ...
    function uploaded_link($id)
    {
        $slider_image_index = array_search($id,json_decode(get_setting('home_slider_images'), true));
        return json_decode(get_setting('home_slider_links'), true)[$slider_image_index];
    }
